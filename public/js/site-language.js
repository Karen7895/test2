(function () {
  ...
  const translations = {
    en: {
      ...
      "profile.subtitle": "Manage your settings, subscription, and learning progress.",
      "profile.tabs.user": "User info",
      "profile.tabs.subscription": "Subscription",
      "profile.tabs.progress": "Learning progress",
      "profile.tabs.settings": "Settings",
      "profile.tabs.support": "Support",
      "profile.user.avatar": "Avatar",
      "profile.user.upload": "Upload",
      "profile.user.name": "Name",
      "profile.user.email": "Email",
      "profile.user.registered": "Member since",
      "profile.user.level": "Level",
      "profile.user.avatarHint": "200 KB max · PNG/JPG/WEBP",
      "profile.subscription.currentPlan": "Current plan",
      "profile.subscription.basic": "Basic",
      "profile.subscription.medium": "Medium",
      "profile.subscription.advanced": "Advanced",
      "profile.subscription.renewal": "Renews on",
      "profile.subscription.upgrade": "Upgrade",
      "profile.subscription.downgrade": "Downgrade",
      "profile.subscription.cancel": "Cancel subscription",
      "profile.subscription.manageInPaypal": "Manage in PayPal",
      "profile.subscription.history": "Payment history",
      "profile.subscription.noPayments": "No payments recorded yet.",
      "profile.progress.overview": "Overview",
      "profile.progress.started": "Stories started",
      "profile.progress.finished": "Stories finished",
      "profile.progress.continue": "Continue reading",
      "profile.progress.resume": "Resume",
      "profile.progress.time": "Reading time (min)",
      "profile.progress.empty": "No in-progress stories yet.",
      ...
      "profile.settings.level": "Your level",
      "profile.settings.aiTeacher": "Preferred AI teacher",
      "profile.settings.changeOnAiPage": "Change on AI Teacher page",
      "profile.settings.save": "Save settings",
      "profile.settings.saved": "Settings saved",
      "profile.support.contact": "Contact support",
      "profile.support.faq": "FAQ",
      "profile.support.report": "Report a problem",
      "profile.support.description": "Description",
      "profile.support.send": "Send",
      "library.title": "Library",
      "library.subtitle": "Browse our collection by your current proficiency level.",
      "library.filters.all": "All",
      "library.filters.ariaLabel": "Filter by level",
      "library.continue.title": "Continue reading",
      "library.readTime": "Reading time: ~%s min",
      "library.read": "Read",
    ...
    es: {
      ...
      "profile.subtitle": "Gestiona tu configuración, suscripción y progreso de aprendizaje.",
      "profile.tabs.user": "Información del usuario",
      "profile.tabs.subscription": "Suscripción",
      "profile.tabs.progress": "Progreso de aprendizaje",
      "profile.tabs.settings": "Configuración",
      "profile.tabs.support": "Soporte",
      "profile.user.avatar": "Avatar",
      "profile.user.upload": "Subir",
      "profile.user.name": "Nombre",
      "profile.user.email": "Correo electrónico",
      "profile.user.registered": "Miembro desde",
      "profile.user.level": "Nivel",
      "profile.user.avatarHint": "200 KB máx · PNG/JPG/WEBP",
      "profile.subscription.currentPlan": "Plan actual",
      "profile.subscription.basic": "Básico",
      "profile.subscription.medium": "Medio",
      "profile.subscription.advanced": "Avanzado",
      "profile.subscription.renewal": "Renueva el",
      "profile.subscription.upgrade": "Mejorar plan",
      "profile.subscription.downgrade": "Cambiar a un plan inferior",
      "profile.subscription.cancel": "Cancelar suscripción",
      "profile.subscription.manageInPaypal": "Gestionar en PayPal",
      "profile.subscription.history": "Historial de pagos",
      "profile.subscription.noPayments": "Aún no hay pagos registrados.",
      "profile.progress.overview": "Resumen",
      "profile.progress.started": "Historias iniciadas",
      "profile.progress.finished": "Historias finalizadas",
      "profile.progress.continue": "Seguir leyendo",
      "profile.progress.resume": "Reanudar",
      "profile.progress.time": "Tiempo de lectura (min)",
      "profile.progress.empty": "Todavía no tienes historias en curso.",
      "profile.settings.language": "Idioma de la interfaz",
      "profile.settings.theme": "Tema",
      "profile.settings.themeDark": "Oscuro",
      "profile.settings.themeLight": "Claro",
      "profile.settings.level": "Tu nivel",
      "profile.settings.aiTeacher": "Profesor IA preferido",
      "profile.settings.changeOnAiPage": "Cambiar en la página de Profesor IA",
      "profile.settings.save": "Guardar ajustes",
      "profile.settings.saved": "Ajustes guardados",
      "profile.support.contact": "Contactar con soporte",
      "profile.support.faq": "FAQ",
      "profile.support.report": "Informar de un problema",
      "profile.support.description": "Descripción",
      "profile.support.send": "Enviar",
      "library.title": "Biblioteca",
      "library.subtitle": "Explora nuestra colección según tu nivel actual de dominio.",
      "library.filters.all": "Todos",
      "library.filters.ariaLabel": "Filtrar por nivel",
      "library.continue.title": "Seguir leyendo",
      "library.readTime": "Tiempo de lectura: ~%s min",
      "library.read": "Leer"
    },
    ru: {
      ...
      "profile.subtitle": "Управляйте настройками, подпиской и прогрессом обучения.",
      "profile.tabs.user": "Информация о пользователе",
      "profile.tabs.subscription": "Подписка",
      "profile.tabs.progress": "Прогресс обучения",
      "profile.tabs.settings": "Настройки",
      "profile.tabs.support": "Поддержка",
      "profile.user.avatar": "Аватар",
      "profile.user.upload": "Загрузить",
      "profile.user.name": "Имя",
      "profile.user.email": "E-mail",
      "profile.user.registered": "С нами с",
      "profile.user.level": "Уровень",
      "profile.user.avatarHint": "Макс. 200 КБ · PNG/JPG/WEBP",
      "profile.subscription.currentPlan": "Текущий план",
      "profile.subscription.basic": "Базовый",
      "profile.subscription.medium": "Стандартный",
      "profile.subscription.advanced": "Продвинутый",
      "profile.subscription.renewal": "Продление",
      "profile.subscription.upgrade": "Повысить план",
      "profile.subscription.downgrade": "Понизить план",
      "profile.subscription.cancel": "Отменить подписку",
      "profile.subscription.manageInPaypal": "Управлять в PayPal",
      "profile.subscription.history": "История платежей",
      "profile.subscription.noPayments": "Платежи ещё не зарегистрированы.",
      "profile.progress.overview": "Обзор",
      "profile.progress.started": "Историй начато",
      "profile.progress.finished": "Историй завершено",
      "profile.progress.continue": "Продолжить чтение",
      "profile.progress.resume": "Продолжить",
      "profile.progress.time": "Время чтения (мин)",
      "profile.progress.empty": "Нет начатых историй.",
      "profile.settings.language": "Язык интерфейса",
      "profile.settings.theme": "Тема",
      "profile.settings.themeDark": "Тёмная",
      "profile.settings.themeLight": "Светлая",
      "profile.settings.level": "Ваш уровень",
      "profile.settings.aiTeacher": "Предпочитаемый ИИ-учитель",
      "profile.settings.changeOnAiPage": "Изменить на странице ИИ Учителя",
      "profile.settings.save": "Сохранить настройки",
      "profile.settings.saved": "Настройки сохранены",
      "profile.support.contact": "Связаться с поддержкой",
      "profile.support.faq": "FAQ",
      "profile.support.report": "Сообщить о проблеме",
      "profile.support.description": "Описание",
      "profile.support.send": "Отправить",
      "library.title": "Библиотека",
      "library.subtitle": "Ищите истории по своему текущему уровню владения.",
      "library.filters.all": "Все",
      "library.filters.ariaLabel": "Фильтровать по уровню",
      "library.continue.title": "Продолжить чтение",
      "library.readTime": "Время чтения: ~%s мин",
      "library.read": "Читать"
    },
    hy: {
      ...
      "menu.profile": "Պրոֆիլ",
      "profile.title": "Քո պրոֆիլը",
      "profile.subtitle": "Կառավարիր կարգավորումները, բաժանորդագրությունը և ուսման առաջընթացը միևնույն վայրից։",
      "profile.tabs.user": "Օգտվողի տվյալներ",
      "profile.tabs.subscription": "Բաժանորդագրություն",
      "profile.tabs.progress": "Սովորելու առաջընթաց",
      "profile.tabs.settings": "Կարգավորումներ",
      "profile.tabs.support": "Աջակցություն",
      "profile.user.avatar": "Ավատար",
      "profile.user.upload": "Վերբեռնել",
      "profile.user.name": "Անուն",
      "profile.user.email": "Էլ. հասցե",
      "profile.user.registered": "Գրանցված է սկսած",
      "profile.user.level": "Մակարդակ",
      "profile.user.avatarHint": "Առավելագույնը 200 ԿԲ · PNG/JPG/WEBP",
      "profile.subscription.currentPlan": "Ընթացիկ փաթեթ",
      "profile.subscription.basic": "Հիմնական",
      "profile.subscription.medium": "Միջին",
      "profile.subscription.advanced": "Ընդլայնված",
      "profile.subscription.renewal": "Թարմացվում է",
      "profile.subscription.upgrade": "Բարձրացնել փաթեթը",
      "profile.subscription.downgrade": "Նվազեցնել փաթեթը",
      "profile.subscription.cancel": "Չեղարկել բաժանորդագրությունը",
      "profile.subscription.manageInPaypal": "Կառավարել PayPal-ում",
      "profile.subscription.history": "Վճարումների պատմություն",
      "profile.subscription.noPayments": "Վճարներ դեռ գրանցված չեն։",
      "profile.progress.overview": "Ակնարկ",
      "profile.progress.started": "Սկսված պատմություններ",
      "profile.progress.finished": "Ավարտված պատմություններ",
      "profile.progress.continue": "Շարունակել ընթերցումը",
      "profile.progress.resume": "Շարունակել",
      "profile.progress.time": "Ընթերցման ժամանակը (րոպե)",
      "profile.progress.empty": "Դեռ չկան ընթացիկ պատմություններ։",
      "profile.settings.language": "Միջերեսի լեզու",
      "profile.settings.theme": "Թեմա",
      "profile.settings.themeDark": "Մուգ",
      "profile.settings.themeLight": "Լուսավոր",
      "profile.settings.level": "Քո մակարդակը",
      "profile.settings.aiTeacher": "Նախընտրելի ԱԻ ուսուցիչ",
      "profile.settings.changeOnAiPage": "Փոխել ԱԻ ուսուցչի էջում",
      "profile.settings.save": "Պահպանել կարգավորումները",
      "profile.settings.saved": "Կարգավորումները պահպանվեցին",
      "profile.support.contact": "Կապ հաստատել աջակցման հետ",
      "profile.support.faq": "ՀՏՀ",
      "profile.support.report": "Տեղեկացնել խնդրի մասին",
      "profile.support.description": "Նկարագրություն",
      "profile.support.send": "Ուղարկել",
      "library.title": "Գրադարան",
      "library.subtitle": "Թերթիր մեր հավաքածուն՝ ըստ քո ներկայիս լեզվի մակարդակի։",
      "library.filters.all": "Բոլորը",
      "library.filters.ariaLabel": "Ֆիլտրել ըստ մակարդակի",
      "library.continue.title": "Շարունակել ընթերցումը",
      "library.readTime": "Ընթերցման ժամանակը՝ ~%s րոպե",
      "library.read": "Կարդալ"
    }
  }
  ...
  function applyTranslations(language) {
    document.querySelectorAll("[data-i18n-key]").forEach((element) => {
      ...
      let translation = resolveTranslation(language, key, defaultValue)
      if (translation !== undefined && translation !== null) {
        if (element.dataset.i18nArgs) {
          translation = formatWithArgs(translation, element.dataset.i18nArgs)
        }
  ...
  function formatWithArgs(template, rawArgs) {
    if (!rawArgs) {
      return template
    }

    const values = rawArgs.split("|").map((value) => value.trim())
    let index = 0
